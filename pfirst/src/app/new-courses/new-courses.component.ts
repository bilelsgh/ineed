...
export class NewCoursesComponent implements OnInit {
  ...
  onSubmitForm() {
    ...
    const content=  { datejour: '',dateheure:'', accompagner:'',budget:'', liste: [],name:'Faire les courses', description: '',type:'service1',user:'', viewNumber : 0, image: '../../assets/data/courses.png' }
