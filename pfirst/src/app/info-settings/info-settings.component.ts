      ...
      reader.onload = (event: any) => {
        ...
        this.compressorService.compressFile(loadedUrl).then(
          (myStatus) => {
            ...
            this.localCompressedURl = this.compressorService.servCompressedURl;
          }
        );
      };
